...
This pattern mirrors what President Eisenhower called the "military-industrial complex" — where government spending creates industries that then lobby for more spending. In our education system, we see:
...
# display the table
knitr::kable(ed_complex, caption = "The Education-Industrial Complex")
