...
This cliche is another form of lying; it presumes we know far more than we can know.  It is a troubling phrase that has moved from courts into schools. As usual, it enters the education system via an industry seen as more rigorous.  This simple-sounding phrase creates big problems when school boards use it to guide decisions.
