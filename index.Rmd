...
The aim is to help boards to solve a problem, or avoid negative consequences.

Hopefully, there are some ideas here that can help boards create opportunities for improvement in their districts.

<div class="callout-tip">
<strong>Think about it...</strong> when's the last time you had any board training to teach you how to improve your systems so you can do more with less? 
</div>
...
<strong>Warning:</strong> Your choices reflect the values of YOUR district - **don't let others choose them for you.**
</div>
